...
type TranslationResource = {
  ...
  options: Record<OptionGroup, Record<string, string>>;
};

export const TRANSLATION_RESOURCES: Record<Lang, TranslationResource> = {
  en: {
    labels: {
      ...
      intro_caption:
        'Fast scenario testing for layout, lease, and town combinations.',
      ...
      missing_lease_commence_date: 'Missing Lease Commence Year!',
      get_prediction: 'Get prediction',
      predicting: 'Predicting...',
      reset_form: 'Reset',
      predicted_trends: 'Predicted Trends for Past 12 Months',
      chart_story_title: 'How the estimate has moved over the last year',
      chart_latest: 'Latest',
